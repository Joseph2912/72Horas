...
public class BloquearPuertas : MonoBehaviour
{
    ...
    private bool cerrarPuerta = false; // Variable para controlar si la llave ha sido recogida



    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player") && !cerrarPuerta) // Verifica si el objeto que colisiona es el jugador y la llave no ha sido recogida
        {
    ...
    private void RecogerLlave()
    {
        ...
        cerrarPuerta = true; // Marca la llave como recogida
